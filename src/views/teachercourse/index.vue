            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button type="primary" size="small" plain
                        @click="visible = true; courseForm = scope.row">修改</el-button>
        ...
        <el-dialog title="修改课程信息" :visible.sync="visible">
            <el-form :model="courseForm">
                ...
                <el-form-item label="所选人数" prop="number">
                    <el-input type="text" v-model="courseForm.number" autocomplete="off" size="small"
                        class="input_width" disabled></el-input>
                </el-form-item>
...
<script>
import { TeacourseList, deleteCourse, updateCourse, addCourse } from '@/api/courses';
...
export default {
    ...
    methods: {
        ...
        fetchCoursesList() {
            ...
            TeacourseList(this.params).then(response => {
